...
- **Disposable 105-request Godot integration fixture** covering Phase 1 and Phase 2 success, undo/redo, persistence, resource ownership, overwrite, malformed input, and unsafe-path cases.

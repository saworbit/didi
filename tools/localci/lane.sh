...
expected="bin/libdidi_extension.so didi.gdextension didi_await.gd didi_brand.gd didi_client_config.gd didi_console.gd didi_diagnostics.gd didi_log.gd didi_mark.svg didi_mark_compact.svg didi_plugin.gd didi_session.gd didi_settings.gd didi_signature.svg plugin.cfg "

...
<<<<<<< HEAD
[![Tests](https://img.shields.io/badge/tests-1029-2ea043?logo=pytest&logoColor=white)](docs/TEST_INVENTORY.md)
||||||| abcf43c
[![Tests](https://img.shields.io/badge/tests-1027-2ea043?logo=pytest&logoColor=white)](docs/TEST_INVENTORY.md)
=======
[![Tests](https://img.shields.io/badge/tests-1028-2ea043?logo=pytest&logoColor=white)](docs/TEST_INVENTORY.md)
...
schema strictness across the surface, and a client written against 1.8.0 can
break on any of them. Didi itself is still `PARTIAL_DELIVERY`: three canonical
tools are registered and unimplemented, and the roadmap phase that owns
compatibility guarantees has not started. See
...
| 🛠️ [**Tool Reference Manual**](docs/TOOL_REFERENCE.md) | **Developers / LLMs** | Current behavior and limits for 116 canonical tools plus 10 legacy names. |
...
│  - Registry (116 canonical tools + 10 legacy names)          │

...
| 🗺️ [**Roadmap & 96-Tool Surface**](docs/ROADMAP.md) | **Developers / Contributors** | Completed phases and technical build order. |
...
| 🛠️ [**Tool Reference Manual**](docs/TOOL_REFERENCE.md) | **Developers / LLMs** | Current behavior and limits for 96 canonical tools plus 10 legacy names. |
...
│  - Registry (96 canonical tools + 10 legacy names)          │

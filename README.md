...
| 🛠️ [**Tool Reference Manual**](docs/TOOL_REFERENCE.md) | **Developers / LLMs** | Current behavior and limits for 113 canonical tools plus 10 legacy names. |
...
│  - Registry (113 canonical tools + 10 legacy names)          │

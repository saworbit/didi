...
[![Tests](https://img.shields.io/badge/tests-1256-2ea043?logo=pytest&logoColor=white)](docs/TEST_INVENTORY.md)
...
| 🛠️ [**Tool Reference Manual**](docs/TOOL_REFERENCE.md) | **Developers / LLMs** | Current behavior and limits for 118 canonical tools plus 10 legacy names. |
...
│  - Registry (118 canonical tools + 10 legacy names)          │

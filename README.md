...
| 🗺️ [**Roadmap & 109-Tool Surface**](docs/ROADMAP.md) | **Developers / Contributors** | Completed phases and technical build order. |
...
| 🛠️ [**Tool Reference Manual**](docs/TOOL_REFERENCE.md) | **Developers / LLMs** | Current behavior and limits for 109 canonical tools plus 10 legacy names. |
...
│  - Registry (109 canonical tools + 10 legacy names)          │

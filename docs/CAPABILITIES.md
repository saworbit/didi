...
Didi registers 40 canonical tool names across nine domains. Twenty-two are implemented in at least one mode; 18 remain reserved and return an MCP tool error.

...
void ToolRegistry::registerAllDefaultTools() {
    ...
    }
    {
        ...
        t.description = "Reimports a validated atomic batch of project source assets and waits for two consecutive editor-idle frames. An import the engine refused is refused, naming the failed paths, with the engine's reason under engine_diagnostics.";
        t.inputSchema = {{"type", "object"}, {"properties", {

...
- **804 automated tests**, 514 of them native C++, counted in
...
[CONTRIBUTING.md](CONTRIBUTING.md#-ai-assisted-contributions). The short version is that
nobody here is going to ask which lines you typed, and the checks will only ask whether it
works.
